...
const tools = [
  { name: "JSON Formatter", desc: "Format, minify & validate JSON", href: "/json-formatter", icon: "{ }" },
  ...
  { name: "Timestamp Converter", desc: "Convert Unix timestamps ↔ dates", href: "/timestamp-converter", icon: "⏱️" },
  ...
  { name: "QR Code Generator", desc: "Generate QR codes from text or URLs", href: "/qr-generator", icon: "📱" },
